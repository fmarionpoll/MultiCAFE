...
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.Deriche;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.H1H2H3;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.ImageMinusBackground;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.L1DistanceToColumn;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.LinearCombination;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.LinearCombinationNormed;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.None;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.RGBtoHSB;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.RGBtoHSV;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.RemoveHorizontalAverage;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.SortChan0Columns;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.SortSumDiffColumns;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.SubtractColumn;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.SubtractReferenceImage;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.SumDiff;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.ThresholdColors;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.ThresholdSingleValue;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.XDiffn;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.XYDiffn;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.YDifferenceL;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.YDiffn;
import plugins.fmp.multicafe.fmp_tools.imageTransform.transforms.YDiffn1D;
