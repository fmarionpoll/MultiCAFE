...
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.Deriche;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.H1H2H3;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.L1DistanceToColumn;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.LinearCombination;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.LinearCombinationNormed;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.NegativeDifference;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.None;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.RGBtoHSB;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.RGBtoHSV;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.RemoveHorizontalAverage;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.SortChan0Columns;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.SortSumDiffColumns;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.SubtractColumn;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.SubtractReferenceImage;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.SumDiff;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.ThresholdColors;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.ThresholdSingleValue;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.XDiffn;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.XYDiffn;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.YDifferenceL;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.YDiffn;
import plugins.fmp.multicafe.tools0.ImageTransform.Transforms.YDiffn1D;
...
public enum ImageTransformEnums {
	...
	YDIFFN("YDiffn", new YDiffn(5)), YDIFFN1D("YDiffn_1D", new YDiffn1D(4)), XYDIFFN("XYDiffn", new XYDiffn(3)),
