...
import plugins.fmp.multicafe.tools1.imageTransform.transforms.Deriche;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.H1H2H3;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.ImageMinusBackground;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.L1DistanceToColumn;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.LinearCombination;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.LinearCombinationNormed;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.None;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.RGBtoHSB;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.RGBtoHSV;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.RemoveHorizontalAverage;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.SortChan0Columns;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.SortSumDiffColumns;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.SubtractColumn;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.SubtractReferenceImage;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.SumDiff;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.ThresholdColors;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.ThresholdSingleValue;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.XDiffn;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.XYDiffn;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.YDifferenceL;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.YDiffn;
import plugins.fmp.multicafe.tools1.imageTransform.transforms.YDiffn1D;
