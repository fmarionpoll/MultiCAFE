...
public enum EnumXLSColumnHeader {
	...
	CAP_STIM("Spot_stimulus", 16, EnumColumnType.COMMON), SPOT_CONC("Spot_concentration", 17, EnumColumnType.COMMON),
	CAP_CONC("Spot_concentration", 17, EnumColumnType.COMMON), SPOT_NFLIES("Nflies", 18, EnumColumnType.COMMON),
