	...
	public static boolean xmlLoadExperiment(Experiment exp, String csFileName) {
		...
		try {
			...
			if (exp.getSeqCamData() != null) {
				plugins.fmp.multicafe.fmp_experiment.sequence.ImageLoader imgLoader = exp.getSeqCamData().getImageLoader();
				...
				plugins.fmp.multicafe.fmp_experiment.sequence.TimeManager timeManager = exp.getSeqCamData().getTimeManager();
