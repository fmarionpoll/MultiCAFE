...
public class SpotsInfo {
	...
	private SpotsInfo(Builder builder) {
	...
	public int getSpotsWithMeasures() {
		return spotsWithMeasures;
	}

	public int getSpotsReadyForAnalysis() {
		return spotsReadyForAnalysis;
	}
	...
	public String toString() {
		return String.format("SpotsInfo{total=%d, valid=%d, withMeasures=%d, ready=%d, timeIntervals=%d}", totalSpots,
				validSpots, spotsWithMeasures, spotsReadyForAnalysis, timeIntervalsCount);
	}
	...
	public static class Builder {
		...
		public SpotsInfo build() {
			return new SpotsInfo(this);
		}
	}
}