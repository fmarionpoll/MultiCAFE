...
/**
 * Encapsulates capillary properties (metadata not directly related to image processing).
 */
public class CapillaryProperties {
	...
	public boolean saveToXml(Node nodeMeta) {
		...
		// limitsOptions.saveToXML(nodeMeta); // Assuming BuildSeriesOptions has saveToXML?
		// Checked legacy code: limitsOptions.loadFromXML(nodeMeta) is called, but saving?
		// Legacy code didn't seem to explicitly save limitsOptions in saveToXml_CapillaryOnly?
		// Wait, checked Capillary.java line 660: boolean flag = xmlSave_Intervals(node); 
		// Ah, limitsOptions seems to be missing an explicit save call in the original Capillary.java xmlSave_CapillaryOnly? 
	...
	// === GETTERS/SETTERS ===
	// (Keeping fields public for now as per plan implies refactoring accessors later, 
	...
	public int getNFlies() { return nFlies; }
	public void setNFlies(int nFlies) { this.nFlies = nFlies; }
	...
	public void setDescriptionOK(boolean descriptionOK) { this.descriptionOK = descriptionOK; }
	
	public int getVersionInfos() { return versionInfos; }
	public void setVersionInfos(int versionInfos) { this.versionInfos = versionInfos; }
	
	public BuildSeriesOptions getLimitsOptions() { return limitsOptions; }
	public void setLimitsOptions(BuildSeriesOptions limitsOptions) { this.limitsOptions = limitsOptions; }
}
