package plugins.fmp.multicafe.fmp_experiment.capillaries.computations;
...
public class CorrelationComputation {
	...
	public static MeasurementComputation computeAutocorrelation() {
		return (exp, cap, options) -> {
			...
			ArrayList<Integer> events = gulps.getMeasuresFromGulps(
					plugins.fmp.multicafe.fmp_tools.results.EnumResults.AUTOCORREL, npoints, binData, binExcel);
	...
	public static MeasurementComputation computeMarkovChain() {
		return (exp, cap, options) -> {
			...
			ArrayList<Integer> events = gulps.getMeasuresFromGulps(
					plugins.fmp.multicafe.fmp_tools.results.EnumResults.MARKOV_CHAIN, npoints, binData, binExcel);
	...
	private static ArrayList<Integer> getGulpEvents(Experiment exp, Capillary cap, ResultsOptions options) {
		...
		return gulps.getMeasuresFromGulps(plugins.fmp.multicafe.fmp_tools.results.EnumResults.AUTOCORREL, npoints,
				binData, binExcel);
	}
